...
// Form struct, which embeds an url.Values object
...
// New function initializes a custom Form struct. Notice that
...
// Required method checks that specific fields in the form
...
// MaxLength method checks that a specific field in the form
